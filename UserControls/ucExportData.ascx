<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ucExportData.ascx.vb"
                    ...
                    <td valign="top">
                        ...
                        <dx:ASPxGridView ID="GvListAnggota" runat="server" AutoGenerateColumns="False" CssFilePath="~/App_Themes/Office2003Blue/{0}/styles.css"
                            ...
                            <Columns>
                                ...
                                <dx:GridViewDataTextColumn Caption="Group ID" FieldName="GroupID" Width="150px" CellStyle-BackColor="#ffffd6"
                                    VisibleIndex="2">
                                ...
                                <dx:GridViewDataTextColumn Caption="Jenis Permohonan" FieldName="JenisPermohonan"
                                    CellStyle-BackColor="#ffffd6" Width="130px" VisibleIndex="3">
                                    <Settings AllowHeaderFilter="True" />
                                    <CellStyle HorizontalAlign="Left" Wrap="False" />
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn Caption="CallSign" FieldName="Callsign" Width="70px" VisibleIndex="4"
                                    CellStyle-BackColor="#ffffd6">
                                ...
                                <dx:GridViewDataTextColumn Caption="Nama" FieldName="Nama" Width="200px" VisibleIndex="5">
                                    <Settings AllowAutoFilter="True" AllowAutoFilterTextInputTimer="True" AllowDragDrop="True"
                                        AllowGroup="True" AllowSort="True" />
                                ...
                                <dx:GridViewDataTextColumn FieldName="NomorKTP" Width="120px" VisibleIndex="6">
                                ...
                                <dx:GridViewDataTextColumn Caption="Orari Daerah" FieldName="OrdaName" Width="100px"
                                    VisibleIndex="8">
                                    <Settings AllowHeaderFilter="True" />
                                    <HeaderStyle HorizontalAlign="Left" />
                                    <CellStyle HorizontalAlign="Left" Wrap="False" />
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn Caption="Orari Lokal" FieldName="OrlokName" Width="100px"
                                    VisibleIndex="9">
                                    <Settings AllowHeaderFilter="True" />
                                    <HeaderStyle HorizontalAlign="Left" Wrap="True" />
                                    <CellStyle HorizontalAlign="Left" Wrap="False" />
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn FieldName="RapiDaerahName" VisibleIndex="10" Caption="Rapi Daerah" Width="120px">
                                    <Settings AllowHeaderFilter="True" />
                                   <HeaderStyle HorizontalAlign="Left" Wrap="True" />
                                    <CellStyle HorizontalAlign="Left" Wrap="False" />
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn Caption="Nomor UNAR" FieldName="NomorUNAR" Width="120px"
                                    VisibleIndex="11">
                                    <Settings AllowAutoFilter="True" AllowAutoFilterTextInputTimer="False" AllowDragDrop="True"
                                        AllowGroup="True" AllowSort="True" />
                                ...
                                <dx:GridViewDataTextColumn Caption="Tanggal UNAR" FieldName="TanggalUNAR" Width="90px"
                                ...
                                <dx:GridViewDataTextColumn Caption="Nomor SKAR" FieldName="NomorSKAR" Width="150px"
                                    VisibleIndex="14">
                                    <Settings AllowAutoFilter="True" AllowAutoFilterTextInputTimer="False" AllowDragDrop="True"
                                        AllowGroup="True" AllowSort="True" />
                                    <HeaderStyle HorizontalAlign="Center" Wrap="True" VerticalAlign="Middle" />
                                ...
                                <dx:GridViewDataTextColumn Caption="Tanggal Terbit SKAR" FieldName="TanggalTerbitSKAR"
                                    Width="90px" UnboundType="DateTime" VisibleIndex="15">
                                    <Settings AllowHeaderFilter="True" />
                                    <PropertiesTextEdit DisplayFormatString="dd-MMM-yyyy" />
                                    <HeaderStyle HorizontalAlign="Center" Wrap="True"></HeaderStyle>
                                    <CellStyle HorizontalAlign="Right" Wrap="False" />
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn Caption="Nomor IAR" FieldName="NomorIAR" Width="150px"
                                    VisibleIndex="16">
                                    <Settings AllowAutoFilter="True" AllowAutoFilterTextInputTimer="False" AllowDragDrop="True"
                                        AllowGroup="True" AllowSort="True" />
                                    <HeaderStyle HorizontalAlign="Center" Wrap="True" VerticalAlign="Middle" />
                                ...
                                <dx:GridViewDataTextColumn Caption="Masa Berlaku IAR" FieldName="MasaBerlakuIAR"
                                    Width="90px" UnboundType="DateTime" VisibleIndex="17">
                                    <Settings AllowAutoFilter="False" AllowAutoFilterTextInputTimer="False" AllowDragDrop="False"
                                ...
                                <dx:GridViewDataTextColumn Caption="Nomor IKRAP" FieldName="NomorIKRAP" Width="150px"
                                    VisibleIndex="18">
                                    <Settings AllowAutoFilter="True" AllowAutoFilterTextInputTimer="False" AllowDragDrop="True"
                                        AllowGroup="True" AllowSort="True" />
                                    <HeaderStyle HorizontalAlign="Center" Wrap="True" VerticalAlign="Middle" />
                                ...
                                <dx:GridViewDataTextColumn Caption="Masa Berlaku IKRAP" FieldName="MasaBerlakuIKRAP"
                                    Width="120px" UnboundType="DateTime" VisibleIndex="19">
                                    <PropertiesTextEdit DisplayFormatString="dd-MMM-yyyy" />
                                    <Settings AllowAutoFilter="True" AllowAutoFilterTextInputTimer="True" 
                                        AllowDragDrop="True" AllowGroup="True" AllowSort="True" />
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn Caption="Proses ID" FieldName="ProsesID" VisibleIndex="20" Visible="False">
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewDataCheckColumn FieldName="ProsesData" Caption="Proses Data" 
                                    VisibleIndex="21">
                                    <Settings AllowHeaderFilter="True" />
                                </dx:GridViewDataCheckColumn>
                            </Columns>
