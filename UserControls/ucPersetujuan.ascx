<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ucPersetujuan.ascx.vb"
    Inherits="UserControls_ucPersetujuan" %>
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <ContentTemplate>
        <table style="width: 980px;" border="0" cellpadding="0" cellspacing="5">
            <tr>
                <td class="style1" colspan="3">
                    PERSETUJUAN
                    <asp:Label ID="lblJudul" runat="server" />
                </td>
            </tr>
            <tr>
                        ...
                        <tr>
                            <td>
                                <asp:CheckBox ID="cbxPilihSemua" runat="server" AutoPostBack="True" Text="Pilih Semua"
                                    ToolTip="Pilih Semua Data" BorderStyle="Ridge" BorderWidth="1px" Font-Names="Calibri"
                                    Font-Size="Small" Width="90px" />
                            </td>
                            <td>
                                <dx:ASPxButton ID="BtnProsesLulusUNAR" runat="server" CssFilePath="~/App_Themes/Office2003Blue/{0}/styles.css"
                                    CssPostfix="Office2003Blue" SpriteCssFilePath="~/App_Themes/Office2003Blue/{0}/sprite.css"
                                    Text="Proses Lulus" Wrap="False" Visible="False" Width="150px" ToolTip="Proses Data yang Lulus UNAR"
                                    HorizontalAlign="Center">
                                    <Image Url="~/Images/Persetujuan2-16x16.png" />
                                </dx:ASPxButton>
                                <dx:ASPxButton ID="BtnProsesIAR" runat="server" CssFilePath="~/App_Themes/Office2003Blue/{0}/styles.css"
                                    CssPostfix="Office2003Blue" SpriteCssFilePath="~/App_Themes/Office2003Blue/{0}/sprite.css"
                                    Text="Proses IAR" Wrap="False" Visible="False" Width="150px" ToolTip="Proses Dapat Nomor IAR" HorizontalAlign="Center">
                                    <Image Url="~/Images/proses-16x16.gif" />
                                </dx:ASPxButton>
                            </td>
                            <td>
                                <dx:ASPxButton ID="BtnProsesGagalUNAR" runat="server" CssFilePath="~/App_Themes/Office2003Blue/{0}/styles.css"
                                    CssPostfix="Office2003Blue" SpriteCssFilePath="~/App_Themes/Office2003Blue/{0}/sprite.css" HorizontalAlign="Center"
                                    Text="Proses Tidak Lulus" Wrap="False" Visible="False" Width="150px" ToolTip="Proses tidak Lulus UNAR">
                                    <Image Url="~/Images/Persetujuan2-16x16.png" />
                                </dx:ASPxButton>
                            </td>
                            <td>
                                <dx:ASPxButton ID="BtnSave" runat="server" CssFilePath="~/App_Themes/Office2003Blue/{0}/styles.css"
                                    CssPostfix="Office2003Blue" SpriteCssFilePath="~/App_Themes/Office2003Blue/{0}/sprite.css"
                                    Text="Ekspor Excel" Wrap="False" Width="150px" ToolTip="Proses Ekspor Data ke File Excel" HorizontalAlign="Center">
                            ...
                            <td>
                                <dx:ASPxButton ID="BtnHapusData" runat="server" CssFilePath="~/App_Themes/Office2003Blue/{0}/styles.css"
                                    CssPostfix="Office2003Blue" SpriteCssFilePath="~/App_Themes/Office2003Blue/{0}/sprite.css"
                                    Text="Hapus Data" Width="150px" Wrap="False" ToolTip="Proses Hapus Data Permanen" HorizontalAlign="Center">
                            ...
                            <td>
                                ...
                                <dx:ASPxButton ID="BtnRefresh" runat="server" CssFilePath="~/App_Themes/Office2003Blue/{0}/styles.css"
                                    CssPostfix="Office2003Blue" SpriteCssFilePath="~/App_Themes/Office2003Blue/{0}/sprite.css"
                                    Text="Perbaharui Data" Width="150px" Wrap="False" ToolTip="Perbaharui Daftar Data" HorizontalAlign="Center">
