<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ucFormIKRAP.ascx.vb" Inherits="UserControls_ucForm" %>
        ...
        <td valign="top">
            <table border="0" cellpadding="0" cellspacing="5" style="width: 100%" class="font-tabel-right-small2">
                ...
                <tr>
                    ...
                    <td class="font-tabel-left-xsmall2">
                        <asp:TextBox ID="TbxRapiDaerah" runat="server" CssClass="TextBox-Flat-Blue" Width="250px"
                            Height="17px"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td class="font-tabel-right-small2">
                        Nomor IKRAP :</td>
                    <td class="font-tabel-left-xsmall2">
                        <asp:TextBox ID="TbxNmrIKRAP" runat="server" CssClass="TextBox-Flat-Blue" Width="250px"
                ...
                <tr>
                    ...
                    <td class="font-tabel-left-xsmall2">
                        <asp:TextBox ID="TbxTglBerlakuIKRAP" runat="server" 
                            CssClass="TextBox-Flat-Blue" Width="250px"
                            Height="17px"></asp:TextBox>
                    </td>
                </tr>
                <tr>
