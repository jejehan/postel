...
Partial Class UserControls_ucTinjauDataKhusus
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Page.IsPostBack = False Then
            ...
            GetMemberList("WHERE ProsesLevel='12'")
        Else
            With GvListAnggota
    ...
    Protected Sub BtnNew_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles BtnNew.Click
        Response.Redirect("~/Pages/FormKhusus.aspx")
    End Sub
    ...
    Protected Sub btnEdit_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        Response.Redirect(String.Format("~/Pages/FormKhusus.aspx?ProsesID={0}&returnurl={1}", ltrlProsesID.Text, "TinjauDataKhusus.aspx"))
    ...
    Protected Sub BtnProses_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles BtnProses.Click
        ...
        Try
            ...
            myString.Append(Split + "No." + SplitMiddle + "Orda" + SplitMiddle + "NamaPanggilan" + SplitMiddle + "NamaPenanggungJawab" + Split + "," + "Kekurangan")
                ...
                If ProsesID <> "" Then
                    ...
                    With dt
                        If .Rows.Count > 0 Then
                            ...
                            NamaPanggilan = .Rows(0)("NamaPanggilan")
                    ...
                    If s = "" Then '--- Jika tidak ada error ---
                        s = qUpdateDataKhusus("13", ProsesID)
                        s = InsertDataProcess(s)
                    ...
                    Else
                        row = row + 1
                        myString.Append(Split + row.ToString + SplitMiddle + Orda + SplitMiddle + Replace(NamaPanggilan, "Ø", "0") + SplitMiddle + NamaLengkap + Split + "," + s)
                        myString.Append(vbCr & vbLf)
